...
const AlumniHero = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(13, 59, 46, 0.85), rgba(13, 59, 46, 0.85)), url('https://placehold.co/1920x1080/0d3b2e/ffffff?text=Our+Alumni')`,
      }}
    >
      {/* Breadcrumb */}
      <div
      ...
      >
        <nav className="flex items-center gap-2 text-sm md:text-base">
          ...
          <span className="text-(--accent-gold) font-medium">Alumni</span>
        </nav>
      </div>
      ...
      <div className="max-w-4xl text-center z-10">
        ...
        >
          ...
          >
            Celebrating the achievements and contributions of our graduates who
