...
const AdmissionHero = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `linear-gradient(rgba(13, 59, 46, 0.85), rgba(13, 59, 46, 0.85)), url('https://placehold.co/1920x1080/0d3b2e/ffffff?text=Admissions+Open')`,
      }}
    >
      {/* Breadcrumb */}
      <div
      ...
      >
        <nav className="flex items-center gap-2 text-sm md:text-base">
          ...
          <span className="text-(--accent-gold) font-medium">Admissions</span>
        </nav>
      </div>
      ...
      <div className="max-w-4xl text-center z-10">
        ...
        >
          <div className="inline-block px-6 py-2 bg-(--accent-gold) rounded-full mb-6">
          ...
          >
            Begin your journey towards academic excellence and spiritual growth at
