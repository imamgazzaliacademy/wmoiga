...
const ContactHero = () => {
  ...
  return (
    <section
      className="relative px-6 py-32 min-h-[50vh] bg-cover bg-center text-white flex flex-col justify-center items-center"
      style={{
        backgroundImage: `linear-gradient(rgba(13, 59, 46, 0.85), rgba(13, 59, 46, 0.85)), url('https://placehold.co/1920x1080/0d3b2e/ffffff?text=Contact+Us')`,
      }}
    >
      {/* Breadcrumb */}
      <div
      ...
      >
        <nav className="flex items-center gap-2 text-sm md:text-base">
          ...
          <span className="text-(--accent-gold) font-medium">Contact</span>
        </nav>
      </div>
